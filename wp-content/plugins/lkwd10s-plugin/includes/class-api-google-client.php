<?php
/**
 * Class Lkwd10s_Api_Google_Client
 */
class Lkwd10s_Api_Google_Client extends Google_Client {
	...
	public function do_request( $target_request_url, $decode_response = false, $request_method = 'GET' ) {
		...
		$response = $this->getIo()->authenticatedRequest(
			new Google_HttpRequest( $this->api_url . $target_request_url, $request_method )
		);
